...
### [我的博客在这里 &rarr;](http://wenguang-liu.github.io)
...
看右边:
![](http://wenguang-liu.top/img/readme-side.png)
...
# Google Analytics
ga_track_id: 'UA-2fda-1'            # 你用Google账号去注册一个就会给你一个这样的id
ga_domain: test.me			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
